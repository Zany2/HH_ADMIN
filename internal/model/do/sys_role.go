...
type SysRole struct {
	...
	DataScope         interface{} // 数据范围（1：全部数据权限 2：自定数据权限 3：本部门数据权限 4：本部门及以下数据权限）默认2
	MenuCheckStrictly interface{} // 菜单树选择项是否关联显示
	DeptCheckStrictly interface{} // 部门树选择项是否关联显示
	Status            interface{} // 角色状态 1正常 2停用 默认1
	DelFlag           interface{} // 删除标志 1正常 2停用 默认1
	CreateBy          interface{} // 创建者 默认0
	UpdateBy          interface{} // 更新者 默认0
	Remark            interface{} // 备注
